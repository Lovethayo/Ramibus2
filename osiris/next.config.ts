...
const nextConfig: NextConfig = {
  ...
  // nothing stopped it.
  typescript: {
    // The browser application is disabled. The internal adapter build only
    // serves API routes; legacy UI-only files are retained as source history
    // but are not part of the RamiBot runtime.
